...
![스크린샷 2025-01-17 오전 1.44.19.png]()
...
2. `sync` 메소드에 대한 주의 사항 3가지
   ...
   ![GCD%201825e7a35f4480afb744c6a03ae953c3/image.png](GCD%201825e7a35f4480afb744c6a03ae953c3/image.png)
...
- 이때 target을 `global()`로 설정하면 시스템에서 제공하는 스레드 풀을 공유한다.
  ...
  - 서로 다른 Queue가 각자에 대한 순서를 유지하면서도 같은 맥락에서 함께 수행하는 것이 가능하다.
    ![GCD%201825e7a35f4480afb744c6a03ae953c3/image%201.png](GCD%201825e7a35f4480afb744c6a03ae953c3/image%201.png)
    ![GCD%201825e7a35f4480afb744c6a03ae953c3/image%202.png](GCD%201825e7a35f4480afb744c6a03ae953c3/image%202.png)
...
![스크린샷 2025-01-17 오전 1.07.35.png]()
